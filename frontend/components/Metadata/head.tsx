...
const HeadData = () => {
  return (
    <Head>
      ...
      <meta
        name="keywords"
        content="Nick Saveliev, portfolio, Full-Stack,
      ...
      <meta
        name="description"
        content="Here you can explore my skills and see how
      ...
      <meta
        ...
        content="Here you can explore my skills and see how I’ve
      ...
      <meta
        ...
        content="DBsF0U0s9DnMSeuYuUHwqlQEIkiGus18o-lQt8vWVKY"
      />
    </Head>
  );
};

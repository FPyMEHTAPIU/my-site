...
const SwiperContainer = () => {
  const setPaginationIndex = (
    ...
    if (setActiveIndex === null) return;
    setActiveIndex(swiper.activeIndex);
    setIsFirstSlide(swiper.activeIndex === 0);
    const bullets = swiper.pagination.bullets;
    const totalBullets = bullets.length;
    const activeBulletIndex = Array.from(bullets).findIndex(
      (bullet: HTMLElement) => {
  ...
  const setSlideIndex = (
    ...
    if (setActiveIndex !== null) setActiveIndex(swiper.activeIndex);
            ...
            !isMobile && typeof window !== "undefined"
              ? isTablet
                ...
                : isDesktop1440
                  ? 135
                  : 175
              : isMobile && paginationId.includes("vertical")
                ? 15
                : 0
          }
    ...
    return (
      <Swiper
        ...
        onSlideChange={(swiper) =>
          setSlideIndex(swiper, setActiveIndex, setIsFirstSlide, setIsLastSlide)
        }

...
const GithubBlock = (link: string) => {
    ...
    return (
      <div className="github-block">
        <div className="arrow-button">
          <a href="/work">
            <img
              src="/arrows/arrow_left_white24.svg"
              loading="lazy"
              alt="back"
            />
          </a>
          ...
          >
            ...
            <img
              src="/arrows/arrow_right_black16.svg"
              loading="lazy"
              alt="arrow-right"
            />
          </a>
  ...
  const GitHubButton = (link: string) => {
    return (
      <a
        className={
          isTablet ? "button-small last-button" : "button-primary last-button"
        }
        href={link}
        target="_blank"
        rel="noreferrer"

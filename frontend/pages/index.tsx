...
const Index = () => {
      ...
      <div className="content-photo">
        {isMobile ? (
          <div className="greeting">
            <p className="body-default black">Hi there! I'm Nick!</p>
          </div>
        ) : (
          <></>
        )}
        <div className="content-container">
          ...
          <div className="text-container">
            <p className="body-default">
              with experience in web development using TypeScript
              and&nbsp;React, mobile app development with React Native,
              and&nbsp;software development using C&nbsp;and&nbsp;C++.
            </p>
            <p className="body-default">
              At my free time I play the guitar, record videos and&nbsp;play
              computer games.
            </p>
          </div>
        </div>
  ...
  return (
    <main>
      ...
      {isMobile ? (
        <h1 style={{ alignSelf: "center", marginBottom: 24 }}>My Projects</h1>
      ) : (
        <div className="projects-link">
          ...
          >
            ...
            <img
              src={
                isMobile || isTablet
                  ? "./arrows/arrow_right_black16.svg"
                  : "./arrows/arrow_right_black24.svg"
              }
              loading="lazy"
              alt="arrow right"
            />
      ...
      {isMobile ? (
        <a
          className="button-small"
          style={{ justifySelf: "stretch", margin: "24px 15px 0" }}
          href="./work"
        >

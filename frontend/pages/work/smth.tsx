    ...
    <main className="main-gap">
      ...
      <div className="work-content-block">
        ...
        <p className="body-default">
          Swipe Me To Hire (SMTH) - a mobile app designed to make job searching
          and hiring stress-free. Developed by the talented team 'Rock Bottom'

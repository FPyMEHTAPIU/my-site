...
const FdF = () => {
  ...
  const [activeIndexProjections, setActiveIndexProjections] =
    useState<number>(0);
    ...
    <main className="main-gap">
      ...
      <div className="work-content-block">
        ...
        <p className="body-default">
          ...
          of a 3D landscape by linking various points (x, y, z). Create a 3D
          model from 2D map of numbers.
        </p>
      ...
      <div className="work-content-block first-content-block">
        ...
        <div className="work-sub-block">
          ...
          <p className="body-default">
            In this stage, the program checks that exactly one argument (a text
            file with the .fdf extension) has been passed. It also verifies that
        ...
        <div className="work-sub-block">
          ...
          <p className="body-default">
            The program reads the file using the get_next_line function and
            stores the content in an array of strings. It also counts the number
            of rows and columns in the map.
          </p>
        </div>
        <div className="work-sub-block">
          <p className="body-default green">3.Map Conversion</p>
          <p className="body-default">
            Here, the map is converted into a struct containing height (z)
            values. The array of strings is transformed into a point struct,
            storing the numeric values. If the map includes colors (separated by
            commas), the program converts these into RGBA format. If no color is
            specified, default colors are applied based on the z value. The
            memory used in the previous step is then freed.
          </p>
        </div>
        <div className="work-sub-block">
          <p className="body-default green">4.Setting Coordinates</p>
          <p className="body-default">
            This step fills the 'point' struct with corresponding x and y
            coordinates.
          </p>
        </div>
        <div className="work-sub-block">
        ...
        <div className="work-sub-block">
          ...
          <p className="body-default">
            After scaling, matrix rotation formulas are applied to change the
            model's angle along the:
          </p>
          <ul>
            <li className="list-dots">
              <p className="body-default">x-axis</p>
            </li>
            <li className="list-dots">
              <p className="body-default">y-axis</p>
            </li>
            <li className="list-dots">
              <p className="body-default">z-axis</p>
            </li>
          </ul>
          <p className="body-default">
            <span className="green">Important!</span> The original angle values
            are stored before rotation. Zooming, height scaling and rotation
      ...
      <div
        ...
        style={{ marginBottom: isMobile || isTablet ? -8 : -16 }}
      >
      ...
      {isMobile
        ? SwiperDefault(
            ...
            isDesktop1440,
            null,
            imageSlideHorizontal,
            gifsZoomRotate,
            setActiveIndexZoom,
            swipeRefZoom,
            "zoom",
          )
        : SwiperImageDesktopHorizontal(
            isMobile,
            isTablet,
            null,
            imageSlideHorizontal,
      ...
      <div className="work-content-block">
        <div className="work-sub-block">
          ...
          <p className="body-default">
            The program converts the 3D coordinates into either isometric or
            orthographic projections. Examples of different projections are
            shown below:
          </p>
        </div>
      </div>
      ...
      >
        <div className="skills-block">
          {FillImageButtons(
            buttonsProjections,
            activeIndexProjections,
            setActiveIndexProjections,
            swipeRefProjections,
          )}
        </div>
      </div>
      ...
      <div className="work-content-block">
        <div className="work-sub-block">
          ...
          <p className="body-default">
            Next, the model is moved to avoid image cropping by aligning it with
            the left and top edges of the screen. It is also centered based on
            the window size. User-controlled movement is added in this phase.
      ...
      <div
        ...
        style={{
          margin: isMobile || isTablet ? "-8px auto 0" : "-16px auto 0",
        }}
      >
      ...
      <div className="work-content-block last-block">
        <div className="work-sub-block">
          ...
          <p className="body-default">
            This section uses the DDA (Digital Differential Analyzer) algorithm
            to draw lines. First, horizontal lines are drawn, followed by
            vertical lines.
          </p>
        </div>
        <div className="work-sub-block">
          <p className="body-default green">
            10. Setting up Keyboard and Mouse Controls
          </p>
          <p className="body-default">
            Here, keys and mouse controls are configured to change between
            isometric and orthographic projections, move the model, rotate it,
            zoom, and adjust the height scaling. After closing the program (by
            pressing ESC or clicking the Close button), all allocated memory is
            cleaned up.
          </p>
        </div>
      </div>

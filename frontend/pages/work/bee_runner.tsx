    ...
    <main className="main-gap">
      ...
      <div className="work-content-block">
        ...
        <p className="body-default">
          In this amusing game, your goal is to escape from a giant bee. Your
          journey won't be easy as you'll encounter numerous obstacles and
          enemies. Only the best players will be able to unlock the Chest of
          Dreams and claim the well-deserved reward!
        </p>
        {FillSkills(currentProject.skills, containerWidth, true)}
      </div>
      <div className="work-content-block">
        <img
          className="horizontal-card horizontal-image"
          src={"/projects/bee_runner/bee_runner.png"}
          alt="image"
          loading="lazy"
        />
        <p className="body-default">
          This project created for the Games Job Fair Spring 2024 LITE - Unity
          Engine Programming Challenge.
        </p>
        <a
          href="https://fpymehtapiu.itch.io/bee-runner"
        ...
        >
          ...
          <img
            src="/arrows/arrow_right_white24.svg"
            alt="arrow right"
            loading="lazy"
          />
        </a>
      ...
      <div className="work-content-block first-content-block">
        ...
        <ul>
          <li className="list-dots">
            <p className="body-default">Jump: Spacebar</p>
          </li>
          <li className="list-dots">
            <p className="body-default">
          ...
          <li className="list-dots">
            <p className="body-default">Pause: Escape (ESC)</p>
          </li>
        </ul>
        <p className="body-default">
          The giant bee can catch you immediately, or you may lose before it
          reaches you. You have a health bar that can deplete before reaching
          your goal, but you're not defenseless! You can evade obstacles and
          shoot enemies. Defeating enemies rewards you with items like coins,
          keys, or healing flasks. Coins can be used to purchase the Chest of
          Dreams, while keys are used to open it. The reward can change your
          life and bring happiness. You also have the option to reset your
          progress, although you won't want to!
        </p>
      </div>
      ...
      <div className="work-content-block last-block">
        ...
        <div className="work-sub-block">
          ...
          <ul>
            ...
            <li className="list-dots">
              <p className="body-default">
                Smooth transition between grounds if number of lines is the
                same.
              </p>
            </li>
            <li className="list-dots">
            ...
            <li className="list-dots">
              <p className="body-default">Calculated spawn positions.</p>
            </li>
            <li className="list-dots">
              <p className="body-default">Deletion of old map sections.</p>
            </li>
          </ul>
        </div>
        <div className="work-sub-block">
          ...
          <ul>
            ...
            <li className="list-dots">
              <p className="body-default">
                Projectiles disappear upon collision with enemies, player,
                ground, or when leaving the screen.
              </p>
            </li>
          </ul>
        </div>
        <div className="work-sub-block">
          ...
          <ul>
            <li className="list-dots">
              <p className="body-default">Speed increases over time.</p>
            </li>
            <li className="list-dots">
              <p className="body-default">
        ...
        <div className="work-sub-block">
          ...
          <ul>
            <li className="list-dots">
              <p className="body-default">
                Collect coins and keys throughout the game to spend on the Chest
                of Dreams.
              </p>
            </li>
            <li className="list-dots">
        ...
        <div className="work-sub-block">
          ...
          <ul>
            ...
            <li className="list-dots">
              <p className="body-default">Main monster: the giant bee.</p>
            </li>
          </ul>
        </div>
        <div className="work-sub-block">
          ...
          <ul>
            ...
            <li className="list-dots">
              <p className="body-default">
                Pause screen (coins, keys, current score, best score, and
                buttons).
              </p>
            </li>
            <li className="list-dots">
            ...
            <li className="list-dots">
              <p className="body-default">Tutorial screen.</p>
            </li>
            <li className="list-dots">
              <p className="body-default">Game over screen.</p>
            </li>
            <li className="list-dots">
              <p className="body-default">Enemies' Health Bar.</p>
            </li>
          </ul>
        </div>
        <div className="work-sub-block">

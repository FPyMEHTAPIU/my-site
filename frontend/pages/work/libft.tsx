    ...
    <main className="main-gap">
      ...
      <div className="work-content-block">
        ...
        <p className="body-default">
          You must redo a set of functions from the libc. Your functions will
          have the same prototypes and implement the same behaviors as the
          originals. They must comply with the way they are defined in their
          man. The only difference will be their names. They will begin with the
      ...
      <div className="work-content-block first-content-block">
        <h2>libft library</h2>
        <p className="body-default">
          This project involves creating my own library with representations of
          standard functions from the libc library and additional functions that
          are not in libc but are useful for working with linked lists
          represented as structs. The library is built using a Makefile from all
          the files in this project. This library will be updated in the future.
        </p>
      </div>
      <div className="work-content-block">
        <h2>usage</h2>
        <p className="body-default">
          To use this library, include "libft.h" in your code and link the
          created libft.a file when compiling your program. This library will be

    ...
    <main className="main-gap">
      ...
      <div className="work-content-block">
        ...
        <p className="body-default">
          This is a game with an auto-shooter mechanic where you just need to
          move, aim, and survive.
        </p>
      ...
      <div className="work-content-block">
        <img
          ...
          src={"/projects/zombie_strike/zombie_strike.jpg"}
          loading="lazy"
          alt="image"
        />
        <a
          href="https://isotopic.io/game/?game=Zombie_Strike"
      ...
      <div className="work-content-block first-content-block">
        ...
        <ul>
          ...
          <li className="list-dots">
            <p className="body-default">Shift + LMB: Just aim.</p>
          </li>
        </ul>
      </div>
      ...
      <div className="work-content-block last-block">
        ...
        <div className="work-sub-block">
          ...
          <ul>
            ...
            <li className="list-dots">
              <p className="body-default">
                Creating a damage system with hit and collision (projectile and
                punch).
              </p>
            </li>
            <li className="list-dots">
            ...
            <li className="list-dots">
              <p className="body-default">
                Implementing the level system and choosing a bonus when leveling
                up.
              </p>
            </li>
            <li className="list-dots">
            ...
            <li className="list-dots">
              <p className="body-default">
                Setting the maximum count of enemies and randomizing their
                spawn.
              </p>
            </li>
            <li className="list-dots">
              <p className="body-default">Adding a score counter.</p>
            </li>
            <li className="list-dots">
              <p className="body-default">
            ...
            <li className="list-dots">
              <p className="body-default">Adding a timer.</p>
            </li>
            <li className="list-dots">
              <p className="body-default">
            ...
            <li className="list-dots">
              <p className="body-default">UI Programming.</p>
            </li>
          </ul>
        </div>
        <div className="work-sub-block">
          ...
          <ul>
            <li className="list-dots">
              <p className="body-default">Main Menu screen.</p>
            </li>
            <li className="list-dots">
              <p className="body-default">Pause screen.</p>
            </li>
            <li className="list-dots">
              <p className="body-default">Tutorial screen.</p>
            </li>
            <li className="list-dots">
              <p className="body-default">Bonus Choose screen.</p>
            </li>
            <li className="list-dots">
              <p className="body-default">Win and Lose screens.</p>
            </li>
            <li className="list-dots">
              <p className="body-default">Buttons design.</p>
            </li>
            <li className="list-dots">
              <p className="body-default">Health- and Experience Bar design.</p>
            </li>
          </ul>
        </div>
        <div className="work-sub-block">
          ...
          <ul>
            <li className="list-dots">
              <p className="body-default">Level environment.</p>
            </li>
            <li className="list-dots">
              <p className="body-default">
            ...
            <li className="list-dots">
              <p className="body-default">Grabbing experience visual effect.</p>
            </li>
          </ul>
        </div>
        <div className="work-sub-block">
          ...
          <p className="body-default">
            All was created by myself with Groovepad except for the grab
            experience sound.
          </p>
        </div>
      </div>

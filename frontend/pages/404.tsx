...
const Page404 = () => {
  ...
  return (
    <main style={{ height: "100vh", justifyContent: "unset" }}>
      ...
      <p className="not-found">{"4{}4"}</p>
      <div className="oops-block" style={{ textAlign: "center" }}>
        {isMobile || isTablet ? (
          <h1 style={{ maxWidth: isMobile ? 262 : "unset" }}>
            Oops! Page Not Found
          </h1>
        ) : (
        ...
        <p
          ...
          style={{ maxWidth: isMobile ? 299 : isTablet ? 421 : 528 }}
        >
          Something went wrong. Please&nbsp;check the URL or go back to the
          homepage.
        </p>
        <a href="/" className="button-small">
          <p className="body-default black">Back to Homepage</p>
          <img
            src="/arrows/arrow_right_black24.svg"
            loading="lazy"
            alt="arrow right"
          />
        </a>

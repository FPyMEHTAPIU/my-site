...
const projects: ProjectCardData[] = [
  ...
  },
  {
    ...
    type: "Web",
    description:
      "A mobile app designed to make job searching and hiring stress-free.",
    location: "internal",
  },
  {
    name: "FdF",
    ...
    type: "Software",
    description:
      "A graphics project that represents a 2D map of numbers in 3D.",
    location: "internal",
  },
  {
    name: "push_swap",
    ...
    type: "Software",
    description:
      "A sorting algorithm that sorts a stack using another one with pre-calculation logic.",
    location: "internal",
  },
  {
    name: "libft",
    ...
    type: "Software",
    description:
      "A custom library that reimplements many standard C functions, along with linked lists and more.",
    location: "internal",
  },
  {
    name: "Bee Runner",
  ...
  },
  {
    ...
    type: "Game",
    description:
      "A top-down auto-shooter game created in Unreal Engine 5 using C++.",
    location: "internal",
  },
];
